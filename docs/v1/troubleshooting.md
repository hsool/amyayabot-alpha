...
**해결:**
1. 설정 페이지 → **API 설정** 탭에서 **"연결하기"** 버튼을 다시 클릭합니다
2. 네이버 로그인 후 권한을 다시 승인합니다
3. 연결 상태가 "연결됨"으로 바뀌면 정상입니다

> 💡 인증 토큰은 일정 시간이 지나면 만료될 수 있습니다. 연결이 끊어지면 재연결하세요.
...
**해결:**
1. 설정 페이지에서 "연결하기" 버튼을 다시 클릭하여 재인증합니다
2. 네이버 로그인 후 권한 승인하면 토큰이 갱신됩니다
